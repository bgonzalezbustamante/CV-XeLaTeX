...
\cvsection{Experiencia docente relevante}

\begin{publications}

\begin{itemize}
\item{\small Escuela de Negocios, {\bfseries Universidad Mayor}, Santiago, Chile}
\begin{itemize}
\item[$\circ$]{\small Aprendizaje Automático para Políticas Públicas y Economía (taller, Prof. Carla Cisternas), primavera 2021}
\end{itemize} 
\item{\small Departamento de Política y Relaciones Internacionales, {\bfseries Universidad de Oxford}, Oxford, UK}
\begin{itemize}
