...
\item{\small Cisternas, C., \& González-Bustamante, B. (2022, {\itshape próximamente}). Ciencias sociales en contextos de represión: Análisis bibliométrico de la producción histórica de la Corporación de Estudios para Latinoamérica (1979-1989). {\itshape e-Ciencias de la Información}.}\vspace{1mm}
