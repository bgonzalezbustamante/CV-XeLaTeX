...
\item{\small Gonz\'alez-Bustamante, B., \& Cisternas, C. ({\itshape próximamente}). Aplicación de ForceAtlas2, un algoritmo de diseño gráfico continúo, para el estudio de las élites. {\itshape Tufte Working Papers}, (1), 1--13.} \vspace{1mm}
