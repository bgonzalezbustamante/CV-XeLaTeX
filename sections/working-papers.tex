...
\item{\small Gonz\'alez-Bustamante, B., \& Cisternas, C. ({\itshape forthcoming}).  Applying ForceAtlas2, a Continuous Graph LayoutAlgorithm, to the Elites Study. Tufte Working Papers, (1), 1--13. {\footnotesize \scshape [in Spanish]}.} \vspace{1mm}
