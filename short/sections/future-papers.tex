...
\item{González-Bustamante, B. (2024, {\itshape second round of review}). Blame-Shifting in Presidential Systems: Corrective Effect of Ministerial Terminations on Approval. Preprint upon request.}\vspace{1mm}
...
\item{González-Bustamante, B. (2024, {\itshape first round of review}). Resignation Calls, Reallocations and Individual Ministerial Terminations in Presidential Democracies. Preprint upon request.}\vspace{1mm} %% \faBriefcase\ {\bfseries Job market paper}.}\vspace{1mm}
