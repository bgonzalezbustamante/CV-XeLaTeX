...
\item{González-Bustamante, B. (2025, {\itshape forthcoming}). Machine Learning and Political Events: Application of a Semi-Supervised Approach to Produce a Dataset on Presidential Cabinets. {\itshape Social Science Computer Review}. Preprint upon request.}\vspace{1mm} %% \\ \faBriefcase\ {\bfseries Job market paper}.}\vspace{1mm}
